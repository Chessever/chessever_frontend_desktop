...
class DesktopCollectionCards extends StatelessWidget {
  ...
  static const double _featureCardHeight = 88;
  static const double _smartCardHeight = 76;
  static const double _wideCardHeight = 100;
    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 2,
            child: _MiniaturesCollectionCard(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: _MiniaturesCollectionCard(
                  onTap:
                      () => onSmartCollectionTap(PremiumGamesType.miniatures),
                ),
              ),
            ],
          ),
...
class _MiniaturesCollectionCard extends StatefulWidget {
  const _MiniaturesCollectionCard({required this.onTap});
