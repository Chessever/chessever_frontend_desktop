...
class _DesktopContextMenuOverlayState<T>
  ...
  Widget build(BuildContext context) {
    ...
    final maxLeft =
        (overlaySize.width - widget.width - 8)
...
class _DesktopContextMenuSurface<T> extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              for (final entry in entries)
                ...
                else if (entry is DesktopContextMenuItem<T>)
                  _DesktopContextMenuRow<T>(item: entry, onSelect: onSelect),
            ],
          ),
        ),
      ),
...
class _DesktopContextMenuRow<T> extends StatefulWidget {
  const _DesktopContextMenuRow({required this.item, required this.onSelect});
