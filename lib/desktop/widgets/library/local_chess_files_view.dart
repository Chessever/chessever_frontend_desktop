...
class LocalChessFilesView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final latestPasteIntoLocalDatabase =
    ...
    useActiveDatabaseWorkspacePasteDispatcher(
      ...
      onPaste:
          (ownership) => latestPasteIntoLocalDatabase.value?.call(ownership),
    );
    final sort = useState(
    ...
    Future<void> pasteIntoLocalDatabase([
      ...
      if (databaseWorkspaceTabId != null && effectiveOwnership == null) return;
      ...
      if (effectiveOwnership?.isCurrent == false) return;
    ...
    latestPasteIntoLocalDatabase.value =
        (ownership) => unawaited(pasteIntoLocalDatabase(ownership));
