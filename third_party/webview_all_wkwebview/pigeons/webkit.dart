...
abstract class WKPreferences extends NSObject {
  ...
  /// Set a Boolean value that indicates whether the web view may display
  /// content full screen through the HTML Fullscreen API
  /// (`Element.requestFullscreen`).
  ///
  /// Requires iOS 15.4 / macOS 12.3; a no-op on older systems.
  ///
