...
class ChessboardColorScheme {
  ...
  static const greenPlastic = ChessboardColorScheme(
    ...
    background: ImageChessboardBackground(
      ...
      darkSquare: Color(0xff59935d),
      image: AssetImage(
        '$_boardsPath/green-plastic.webp',
        package: 'chessground',
      ),
    ),
    whiteCoordBackground: ImageChessboardBackground(
  ...
  static const horsey = ChessboardColorScheme(
    ...
    lastMove: HighlightDetails(
      image: AssetImage(
        '$_boardsPath/horsey.last-move.webp',
        package: 'chessground',
      ),
    ),
    selected: HighlightDetails(
      image: AssetImage(
        '$_boardsPath/horsey.selected.webp',
        package: 'chessground',
      ),
    ),
    validMoves: Color(0x4014551e),
  ...
  static const newspaper = ChessboardColorScheme(
    ...
    background: ImageChessboardBackground(
      lightSquare: Color(0xffffffff),
      darkSquare: Color(0xff8d8d8d),
      image: AssetImage('$_boardsPath/newspaper.webp', package: 'chessground'),
    ),
    whiteCoordBackground: ImageChessboardBackground(
      lightSquare: Color(0xffffffff),
      darkSquare: Color(0xff8d8d8d),
  ...
  static const purple = ChessboardColorScheme(
    ...
    background: ImageChessboardBackground(
      lightSquare: Color(0xff9f90b0),
      darkSquare: Color(0xff7d4a8d),
      image: AssetImage('$_boardsPath/purple.webp', package: 'chessground'),
    ),
    whiteCoordBackground: ImageChessboardBackground(
      lightSquare: Color(0xff9f90b0),
      darkSquare: Color(0xff7d4a8d),
