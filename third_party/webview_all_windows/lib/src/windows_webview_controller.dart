...
class WindowsWebViewController extends PlatformWebViewController {
  ...
  /// Whether the document currently contains a full-screen element
  /// (`ICoreWebView2.ContainsFullScreenElement`).
  ///
  /// WebView2 only ever sizes a full-screen element to the WebView's own
  /// bounds; the host decides what "full screen" means for its window and
  /// listens here to grow and restore the WebView accordingly.
  Stream<bool> get containsFullScreenElementChanged =>
      _webviewController.containsFullScreenElementChanged;
