...
void main() {
  test('desktop feedback surfaces use Feedback as the sole title', () {
    expect(desktopFeedbackDialogTitle, 'Feedback');
    expect(desktopFeedbackDialogTitle, isNot(contains('Report issue')));
  });
